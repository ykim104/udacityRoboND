...
echo_and_run cd "/home/nvidia/catkin_ws/src/ros_comm/tools/rosbag"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/nvidia/catkin_ws/src/ros_comm/tools/rosbag/setup.py" \
    build --build-base "/home/nvidia/catkin_ws/build/ros_comm/tools/rosbag" \
    install \
    $DESTDIR_ARG \
