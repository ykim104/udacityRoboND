...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_SOURCE_PREFIX /home/nvidia/catkin_ws/src/ros_comm/tools/rosbag)
  set(rosbag_DEVEL_PREFIX /home/nvidia/catkin_ws/devel)
  set(rosbag_INSTALL_PREFIX "")
  set(rosbag_PREFIX ${rosbag_DEVEL_PREFIX})
else()
  set(rosbag_SOURCE_PREFIX "")
  set(rosbag_DEVEL_PREFIX "")
  set(rosbag_INSTALL_PREFIX /home/nvidia/catkin_ws/install)
...
if(NOT "/home/nvidia/catkin_ws/src/ros_comm/tools/rosbag/include " STREQUAL " ")
  set(rosbag_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/catkin_ws/src/ros_comm/tools/rosbag/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/src/ros_comm/tools/rosbag/${idir}'.  ${_report}")
    endif()
