...
if("TRUE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /home/nvidia/catkin_ws/src/ros_comm/tools/rostest)
  set(rostest_DEVEL_PREFIX /home/nvidia/catkin_ws/devel)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX /home/nvidia/catkin_ws/install)
...
if(NOT "/home/nvidia/catkin_ws/src/ros_comm/tools/rostest/include;/usr/include " STREQUAL " ")
  set(rostest_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/catkin_ws/src/ros_comm/tools/rostest/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/catkin_ws/src/ros_comm/tools/rostest/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rostest_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_thread.so;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so;/usr/lib/aarch64-linux-gnu/libpthread.so")
